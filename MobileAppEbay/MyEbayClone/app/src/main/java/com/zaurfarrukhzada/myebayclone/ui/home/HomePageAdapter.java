...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (homePageModelList.get(position).getType()){
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                ((HorizontalProductViewHolder)holder).setHorizontalProductLayout(horizontalScrollProductModelList,horizontalLayoutTitle,layoutColor);
                break;
            case HomePageModel.GRID_PRODUCT_VIEW:
    ...
    public class StripAddBannerViewHolder extends RecyclerView.ViewHolder{
        ...
        private  void setStripAdd(String  resource){
            Glide.with(itemView.getContext()).load(resource)
                    .apply(new RequestOptions().placeholder(R.drawable.home)).into(stripAdImage);
    ...
    public class HorizontalProductViewHolder extends  RecyclerView.ViewHolder{
        ...
        public void setHorizontalProductLayout(List<HorizontalScrollProductModel> horizontalScrollProductModelList,String title,String color){
