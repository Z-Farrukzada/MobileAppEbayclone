...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductSpecificationAdapter.ViewHolder holder, int position) {
        switch (productSpecificationModelList.get(position).getType()){
            ...
            case ProductSpecificationModel.SPECIFICATION_BODY:
                ...
                String FeatureDescription =productSpecificationModelList.get(position).getFeatureValue();
                holder.setFeatures(FeatureTitle,FeatureDescription);
                break;
            default:return;
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setFeatures(String featureTitle,String featureDescription){
            featureName =itemView.findViewById(R.id.feature_name);
            featureValue=itemView.findViewById(R.id.feature_value);
           featureName.setText(featureTitle);
           featureValue.setText(featureDescription);
        }
    }
